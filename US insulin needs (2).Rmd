...
nhanes <- nhanes %>%
  dplyr::select("RIDAGEYR","RIAGENDR","RIDRETH1", "BMXWT","URDACT","SMQ040","BPXSY1","BPQ050A","LBDHDD","LBXTC","LBXSCR", "MCQ160E","MCQ160F", "DIQ010","LBXGH","WTSAF2YR","LBXGLU","DIQ050","DIQ070","LBXSATSI","DID040", "INDFMPIR", "WTINT2YR", "SDMVPSU", "SDMVSTRA") %>%
  as_tibble()
